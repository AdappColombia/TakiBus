...
class Reservas  extends Component {
  ...
  */
      ...
      puesto = async (val,horario) => {
        ...
        Swal
        .fire({
            title: "Número de cedula para la reserva",
            input: "number",
            showCancelButton: true,
            confirmButtonText: "Aceptar",
            cancelButtonText: "Cancelar",
            inputValidator: cedula => {
                if (!cedula) {
                    return "Por favor escribe número de cedula";
                } else {
                    return undefined;
                }
            }
        ...
        .then(resultado => {
            if (resultado.value) {
                let cedula_response = resultado.value;
            ...
            case "Ipiales Bogotá":
              ...
              firebase.database().ref().child("reservas").child(fecha).child(horario).child("Ipi-Bog").child("puestos").push({id_pre_compra:"Ipi-Bog",puesto:val,val_puesto:valPuesto,hora_viaje:horario,fecha_viaje:fecha,cedula:cedula_response},
              error => {
              ...
              case "Ipiales Cali":
                ...
                firebase.database().ref().child("reservas").child(fecha).child(horario).child("Ipi-Cal").child("puestos").push({id_pre_compra:"Ipi-Cal",puesto:val,val_puesto:valPuesto,hora_viaje:horario,fecha_viaje:fecha,cedula:cedula_response},
                error => {
                  if (error) console.log(error)
                });
              ...
              case "Ipiales Medellin Sur":
                ...
                firebase.database().ref().child("reservas").child(fecha).child(horario).child("Ipi-Med").child("puestos").push({id_pre_compra:"Ipi-Med",puesto:val,val_puesto:valPuesto,hora_viaje:horario,fecha_viaje:fecha,cedula:cedula_response},
                error => {
                  if (error) console.log(error)
                });
              ...
              case "Bogotá Ipiales":
                ...
                firebase.database().ref().child("reservas").child(fecha).child(horario).child("Bog-Ipi").child("puestos").push({id_pre_compra:"Bog-Ipi",puesto:val,val_puesto:valPuesto,hora_viaje:horario,fecha_viaje:fecha,cedula:cedula_response},
              ...
              case "Cali Ipiales":
                ...
                firebase.database().ref().child("reservas").child(fecha).child(horario).child("Cal-Ipi").child("puestos").push({id_pre_compra:"Cal-Ipi",puesto:val,val_puesto:valPuesto,hora_viaje:horario,fecha_viaje:fecha,cedula:cedula_response},
                error => {
                  if (error) console.log(error)
                });
                ...
                case "Medellin Sur Ipiales":
                  ...
                  firebase.database().ref().child("reservas").child(fecha).child(horario).child("Med-Ipi").child("puestos").push({id_pre_compra:"Med-Ipi",puesto:val,val_puesto:valPuesto,hora_viaje:horario,fecha_viaje:fecha,cedula:cedula_response},
                  error => {
                    if (error) console.log(error)
                  });
      ...
      peticionDelete  =async  () => {
        ...
        Swal.fire({
          title: 'Alerta',
          text: "Desea liberar el puesto "+this.state.prereserva.puesto,
          icon: 'warning',
          showCancelButton: true,
          ...
          if (result.isConfirmed) {
            ...
            firebase.database().ref().child(`reservas/${this.state.prereserva.fecha_viaje}/${this.state.prereserva.hora_viaje}/${this.state.prereserva.id_pre_compra}/puestos/${this.state.id}`).remove(
                error => {
                  if (error) console.log(error)
            });
                                        ...
                                        <table className="table tabla">
                                          ...
                                          <tbody>
                                            ...
                                            return <><tr>
                                              ...
                                              <th scope="row">{this.state.reservas[i].puesto}</th>
    
                                              <td>

                                                

                                                <button className="btn btn-danger" onClick={()=>this.seleccionarPuesto(this.state.reservas[i], i,this.state.reservas[i].fecha_viaje,this.state.reservas[i].hora_viaje,this.state.reservas[i].id_pre_compra )}>Liberar</button>
